...
function orb_inertialize, frame_bx
 ...
 nt = n_elements(frame_bd)


 orient = bod_orient(frame_bd)
 ...
 if(w[0] NE -1) then $
  iframe_xx[0,*,w] = orb_get_ascending_node(frame_bd[w], inertial_bd[w], /safe)
 ...
 iframe_bd = nv_clone(frame_bd)
 bod_set_orient, iframe_bd, iorient
