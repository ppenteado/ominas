...
;
;===========================================================================
function _glb_get_cusp_points, gbdp, r1, r2, epsilon, niter
  ...
  begin
   ...
   while(NOT done) do $
    begin
     ...
     ;---------------------------------
     rcusp_surface = glb_body_to_globe(gbdp, v)
     rcusp_surface[*,2] = 0d
     rcusp_body[i,*] = glb_globe_to_body(gbdp, rcusp_surface)
...
;
;===========================================================================
function glb_get_cusp_points, gbxp, r1, r2, epsilon, niter
@nv_lib.include
 ...
 for t=0, nt-1 do $
  result[*,*,t] = _glb_get_cusp_points(gbdp[t], r1[*,*,t], r2[*,*,t], epsilon, niter)
