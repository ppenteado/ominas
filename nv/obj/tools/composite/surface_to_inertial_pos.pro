...
;+
; NAME:
;       surface_to_inertial_pos
;
;
; PURPOSE:
;       Transforms position vectors in any surface coordinate system to inertial
;	coordinates.
;
;
; CATEGORY:
...
;
; CALLING SEQUENCE:
;       result = surface_to_inertial_pos(bx, surface_pts)
;
;
; ARGUMENTS:
;  INPUT:
...
;-
;=============================================================================
function surface_to_inertial_pos, bx, p
