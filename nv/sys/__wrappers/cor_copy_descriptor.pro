...
;-
;=============================================================================
pro cor_copy_descriptor, crdp_dst, crdp_src, noevent=noevent
return, nv_copy, crdp_dst, crdp_src, noevent=noevent
@nv_lib.include
 nv_notify, crdp_src, type = 1, noevent=noevent
 new_crd = nv_dereference(crdp_src)

 crd_src = nv_dereference(crdp_src)
 crd_dst = nv_dereference(crdp_dst)
 new_crd.idp = crd_dst.idp
 ...
 nv_notify, crdp_dst, noevent=noevent
end
;==============================================================================
