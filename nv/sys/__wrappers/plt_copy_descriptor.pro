...
;-
;==============================================================================
pro plt_copy_descriptor, pdp_dst, pdp_src, noevent=noevent
return, nv_copy, pdp_dst, pdp_src, noevent=noevent
@nv_lib.include
 nv_notify, pdp_src, type = 1, noevent=noevent
 ...
 nv_notify, pdp_dst, noevent=noevent
end
;==============================================================================
