...
;-
;==============================================================================
pro stn_copy_descriptor, stdp_dst, stdp_src, noevent=noevent
return, nv_copy, sdstdp_dst, stdp_srcrc, noevent=noevent
@nv_lib.include
 nv_notify, stdp_src, type = 1, noevent=noevent
 ...
 nv_notify, stdp_dst, noevent=noevent
end
;==============================================================================
