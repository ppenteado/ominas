...
;-
;==============================================================================
pro _cam_copy_descriptor, cdp_dst, cdp_src, noevent=noevent
 nv_notify, cdp_src, type = 1, noevent=noevent
 ...
 nv_notify, cdp_dst, noevent=noevent
end
;==============================================================================
...
;
;==============================================================================
pro cam_copy_descriptor, cdp_dst, cdp_src, noevent=noevent
return, nv_copy, cdp_dst, cdp_src, noevent=noevent
@nv_lib.include
 nv_notify, cdp_src, type = 1, noevent=noevent
