...
;-
;==============================================================================
pro _glb_copy_descriptor, gbdp_dst, gbdp_src, noevent=noevent
 nv_notify, gbdp_src, type = 1, noevent=noevent
 new_gbd = nv_dereference(gbdp_src)

 sld_copy_descriptor, new_gbd.sld, glb_body(gbdp_src)

 nv_rereference, gbdp_dst, new_gbd
 nv_notify, gbdp_dst, noevent=noevent
end
;==============================================================================
...
;
;==============================================================================
pro glb_copy_descriptor, gbdp_dst, gbdp_src, noevent=noevent
return, nv_copy, gbdp_dst, gbdp_src, noevent=noevent
@nv_lib.include
 nv_notify, gbdp_src, type = 1, noevent=noevent
