...
;-
;=============================================================================
pro nv_header_value, ddp, keyword, get=get, set=set, noevent=noevent
@nv.include
 if(arg_present(get)) then nv_notify, ddp, type = 1, noevent=noevent

 dd = nv_dereference(ddp)

 header = nv_header(ddp, /noevent)
