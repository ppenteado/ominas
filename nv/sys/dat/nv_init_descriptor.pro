...
;-
;=============================================================================
function nv_init_descriptor, crd=crd, dd=dd, $
@nv__keywords.include
silent=silent
@nv.include


 if(NOT keyword_set(dd)) then dd={data_descriptor}
 dd.class = 'DATA'
 dd.abbrev = 'DAT'



 if(keyword_set(crd)) then dd.crd = crd $
 else dd.crd=cor_init_descriptors(1, $
