...
wget=${OWNDIR}/pp_wget
echo "This script wiill download the OMINAS maps package from Github (https://github.com/nasa/ominas_maps). As of August/2017, this adds to 990 MB of download,"
...
baseurl="https://github.com/nasa/ominas_maps"
...
if [ ! -d ${1} ]; then
  git clone https://github.com/nasa/ominas_maps ${1}
else
