; $Id: cw__form.pro,v 1.25 1999/10/15 01:30:24 ali Exp $
;
...
;
;===========================================================================
function CW__FORM_PARSE, Extra, Name, Value, Index=Index
...
;
;===========================================================================
pro CW__FORM_APPEND, extra, e, keyword, USE_VALUE=use_value, ACTUAL_KEYWORD=akw
  COMPILE_OPT hidden
...
;
;===========================================================================
pro CW__FORM_LABEL, parent, nparent, e, frame
...
;
;===========================================================================
;pro CW__FORM_BUILD, parent, desc, cur, ids, lasttag
pro CW__FORM_BUILD, parent, desc, cur, ids, tags, lasttag   ; Spitale, 7/2002
...
;
  ...
  while cur lt n do begin
	...
	frame = CW__FORM_PARSE(e, 'FRAME')
        title = ''
	temp = CW__FORM_PARSE(e, 'TITLE', title)		; Spitale 10/2012
	scroll = CW__FORM_PARSE(e, 'SCROLL')		; Spitale 12/2002
	...
	ww = where(strtrim(e,2) NE '')			; Spitale 12/2002
	if(ww[0] EQ -1) then e = '' $			; Spitale 12/2002
	else e = e[ww]					; Spitale 12/2002
    endif else e = ''

    case STRUPCASE(a[1]) of		;Which widget type?
'TAB': BEGIN
    new = WIDGET_TAB(parent)
    if(keyword__set(e)) then type = 12			; Spitale 10/2012
    value = 0L						; Spitale 10/2012
    uextra = { VALUE: value }    			; Spitale 10/2012
    ENDCASE
'BASE': BEGIN
    new = WIDGET_BASE(parent, FRAME=frame, _EXTRA=extra, scroll=scroll, title=title)
    if(keyword__set(e)) then type = 11			; Spitale 12/2002
    value = 0L						; Spitale 12/2002
    uextra = { VALUE: value }    			; Spitale 12/2002
    ENDCASE
'BUTTON': BEGIN
...
process_integer:
    ...
    all_events = cw__form_parse(e, 'ALL_EVENTS', temp)	; Spitale, 7/2002
...
;		XSIZE=width, UVALUE=ids[n])
    new = WIDGET_TEXT(nparent, all_events=all_events, /EDITABLE, YSIZE=1, $
		XSIZE=width, UVALUE=ids[n])		 ; Spitale, 7/2002
...
'LABEL': BEGIN
    ...
    if(keyword__set(e)) then type = 12			; Spitale 12/2002
    value = 0L						; Spitale 12/2002
    uextra = { VALUE: value }    			; Spitale 12/2002
    ENDCASE
'LIST': BEGIN
...
'TEXT': BEGIN
    type=5
    value = ''
    goto, process_integer	; comment by Spitale -- this is freakin' lame 
    ENDCASE
else: BEGIN
...
;    if dflags and 1 then CW__FORM_BUILD, new, desc, cur, ids, lasttag;Begin new
    if dflags and 1 then $
       CW__FORM_BUILD, new, desc, cur, ids, tags, lasttag  ; Spitale 7/2002
...
;
;===========================================================================
Function CW__FORM_EVENT, ev		;Event handler for CW__FORM
  COMPILE_OPT hidden
...
;
;===========================================================================
Pro CW__FORM_SETV, id, value	;In this case, value = { Tagname : value, ... }
  COMPILE_OPT hidden
...
;
;===========================================================================
Function CW__FORM_GETV, id	;Return value of a CW__FORM widget.
  COMPILE_OPT hidden
...
;===========================================================================
; cw__form_modal_event
;
;===========================================================================
pro cw__form_modal_event, ev
  COMPILE_OPT hidden
...
;  ON_ERROR, 2						;return to caller
  ...
  tags = strarr(n+2)		; Spitale; 7/2002
...
;  CW__FORM_BUILD, base, desc, 0, ids, lasttag
  CW__FORM_BUILD, base, desc, 0, ids, tags, lasttag	; Spitale 7/2002
