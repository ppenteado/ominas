...
;
;==============================================================================
function ccpsf_filename_vicar, dir, inst, filters, size=size, default=default, filespec=filespec
...
;
;==============================================================================
function ccpsf_filename_dat, dir, inst, filters, size=size, default=default, filespec=filespec
...
;format='vicar'
 ...
 dir = getenv('CAS_ISS_PSF')
 if(NOT keyword_set(dir)) then $
     nv_message, verb=0.1, 'CAS_ISS_PSF environment variable not defined.', $
          exp='This directory ponts to the location of the Cassini ISS ' + $
              'Point-Spread-Function files.'
 dir = dir + sep

 ff = call_function('ccpsf_filename_' + format, dir, inst, filters, size=size, default=default, filespec=filespec)
 if(NOT keyword_set(ff)) then $
  begin
   nv_message, /warning, $
