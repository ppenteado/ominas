...
#cat ~/.ominas/ominas | sed -e "s|exec \$BIN_DIR/\$APPLICATION|exec \$BIN_DIR/\$APPLICATION -IDL_STARTUP \${OMINAS_DIR}/util/printver.pro |g" > ~/.ominas/ominas_tmp
cat ~/.ominas/ominas | sed -e "s|\"\$@\" \$APP_ARGS|\"\$@\" \$APP_ARGS -IDL_STARTUP \${OMINAS_DIR}/util/printver.pro |g" > ~/.ominas/ominas_tmp
...
#cat ~/.ominas/ominasde | sed -e "s|exec \$BIN_DIR/\$APPLICATION|exec \$BIN_DIR/\$APPLICATION -IDL_STARTUP \${OMINAS_DIR}/util/printver.pro |g" > ~/.ominas/ominasde_tmp
cat ~/.ominas/ominasde | sed -e "s|\"\$@\" \$APP_ARGS|\"\$@\" \$APP_ARGS -IDL_STARTUP \${OMINAS_DIR}/util/printver.pro |g" > ~/.ominas/ominasde_tmp
