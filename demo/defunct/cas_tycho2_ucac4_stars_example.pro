...
;
;  ominas cas_tycho2_ucac4_stars_example
;
; or from within an OMINAS IDL session using::
;
;  @cas_tycho2_ucac4_stars_example
;
...
; ======================
;
; This first section uses `dat_read` to read in the image. The
; available image file to use for the preocessing:
;
...
;
; This line specifies that the tycho2 (or ucac4) catalog should be used, and all
...
;
; Note: Of the current supported star catalogs, only SAO has spectral types
;
; Code::
;
;  tvim, im
