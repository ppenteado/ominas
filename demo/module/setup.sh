...
export OMINAS_TRANSLATOR_TABLE=${OMINAS_DEMO_DATA}/translators.tab
export OMINAS_TRANSFORM_TABLE=${OMINAS_DEMO_DATA}/transforms.tab
export OMINAS_IO_TABLE=${OMINAS_DEMO_DATA}/io.tab
export OMINAS_FILETYPE_TABLE=${OMINAS_DEMO_DATA}/filetype_detectors.tab
export OMINAS_INSTRUMENT_TABLE=${OMINAS_DEMO_DATA}/instrument_detectors.tab
