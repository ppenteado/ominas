...
common cor_class_info_block, _class, _abbrev, _tag
 ...
 for i=0, nclass-1 do xd[i] = obj_new('ominas_'+class[i], /simple)
...
;=============================================================================
pro ___cor_class_info, class=class, abbrev=abbrev, tag=tag
common cor_class_info_block, _class, _abbrev, _tag
 ...
 ;--------------------------------------------------
 ; create prototype objects and get abbrev and tag
 ;--------------------------------------------------
 xd = objarr(nclass)
