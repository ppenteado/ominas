...
;-
;=============================================================================
function map_map_to_image_mercator, md, map_pts
...
;=============================================================================
function _map_map_to_image_mercator, md, map_pts, valid=valid
 _md = cor_dereference(md)
 ...
 result = dblarr(2,nv,nt, /nozero)
 ecc = make_array(nv, nt, val=map_radii_to_ecc(_md.radii))
 ...
 result[0,*,*] = a[1] * (map_pts[1,*,*]-_md.center[1]) + _md.origin[0]
