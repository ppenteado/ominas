...
libdata[libdataItem++] = new Array("obj/cor/cor_substitute_xd.html", "cor_substitute_xd.pro", '.pro file in <a href="obj/cor/dir-overview.html">obj/cor/ directory</a>', "cor_substitute_xd.pro", "", "", "	Replaces objects in generic descriptors and arrays.    ", "", "          -1", " 	Written by:	Spitale, 8/2017   ");
...
libdata[libdataItem++] = new Array("obj/glb/glb_intersect.html", "glb_intersect.pro", '.pro file in <a href="obj/glb/dir-overview.html">obj/glb/ directory</a>', "glb_intersect.pro", "", "", "", "", "          -1", "");
  ...
  libdata[libdataItem++] = new Array("obj/glb/glb_intersect.html#glb_intersect", "glb_intersect", 'routine in <a href="obj/glb/glb_intersect.html">glb_intersect.pro</a>', "glb_intersect.pro", "", "glb_intersect", "	Computes the intersection of rays with GLOBE objects.    ", "hitArray giving the indices of rays that hit the object in 		the forward direction.   missArray giving the indices of rays that miss the object.   back_pts 		Array (nv,3,nt) of additional intersections in order of distance 		from the observer.    discriminantDiscriminant of the quadriatic equation used to 			determine the intersections.   nosolveIf set, the intersections are not computed, though the 		 discriminant is.   scoreArray in which each element indicates the number of forward hits.   epsilongbd	Array (nt) of any subclass of GLOBE descriptors.   view_ptsArray (nv,3,nt) giving ray origins in the BODY frame.   _ray_ptsArray (nv,3,nt) giving ray directions in the BODY frame.    ", "NV/LIB/GLB", " 	Written by:	Spitale, 1/1998  	Adapted by:	Spitale, 5/2016   	Array (nv,3,nt) of points in the BODY frame corresponding to the 	first intersections with the ray.  Zero vector is returned for points 	with no solution, including those behind the viewer.    STATUS: 	Complete    ");
...
libdata[libdataItem++] = new Array("obj/glb/glb_reflect.html", "glb_reflect.pro", '.pro file in <a href="obj/glb/dir-overview.html">obj/glb/ directory</a>', "glb_reflect.pro", "", "", "", "", "          -1", "");
  ...
  libdata[libdataItem++] = new Array("obj/glb/glb_reflect.html#glb_reflect", "glb_reflect", 'routine in <a href="obj/glb/glb_reflect.html">glb_reflect.pro</a>', "glb_reflect.pro", "", "glb_reflect", "	Computes the reflection of rays with GLOBE objects.    ", "hitmissallvalidgbdArray (nt) of any subclass of GLOBE descriptors.   vArray (nv,3,nt) giving observer positions in the BODY frame.   rArray (nv,3,nt) giving point positions in the BODY frame.   epsilonControls the precision of the iteration.  Default 			is 1d-3.   niterMaximum number of iterations, default is 1000    ", "NV/LIB/GLB", " 	Written by:	Spitale, 6/2016   	Array (nv,3,nt) of points in the BODY frame.  Zero 	vector is returned for points with no solution.    STATUS: 	Not well tested    ");
...
libdata[libdataItem++] = new Array("com/pg/pg_reposition.html", "pg_reposition.pro", '.pro file in <a href="com/pg/dir-overview.html">com/pg/ directory</a>', "pg_reposition.pro", "", "", "", "", "          -1", "");
  ...
  libdata[libdataItem++] = new Array("com/pg/pg_reposition.html#pg_reposition", "pg_reposition", 'routine in <a href="com/pg/pg_reposition.html">pg_reposition.pro</a>', "pg_reposition.pro", "", "pg_reposition", "	Modifies the body position based on the given offset and observer.    	pg_reposition modifies bx and adds its name to the task list of each given 	descriptor.    STATUS: 	Complete    ", "bxArray (nt) of body descriptors to translate.   odObserver descriptor; specifies the body frame for the 		translation vector.   ref_bxBody descriptor giving reference position for directional 		keywords.   ddData descriptor containing a generic descriptor to use 		if gd not given.   gdGeneric descriptor.  If given, the descriptor inputs 		are taken from this structure if not explicitly given.   towardBody should be translated toward ref_bx (default).   awayBody should be translated away from ref_bx.   atBody should be placed at the position of ref_bx.   alongIndex of bx axis along which to translate.   absolute 		If set, dv is taken as an absolute position instead of an 		offset.    _dv	Array (nv,3,nt) specifying the translation vector. 			The components are assumed to be given wrt to the 			inertial frame unless od is given.  In that case 			dv is interpreted as a vector in the body frame of od.  			For convenience, if dv is given in the nonstandard form 			of a 3-element array, it is reinterpreted as a column 			vector (1,3).  			If ref_bx is given, then dv is interpreted as a distance 			and the direction is constructed from one of the directional 			keywords below.   ", "NV/PG", " 	Written by:	Spitale, 3/2007   ");
...
libdata[libdataItem++] = new Array("obj/tools/raytrace.html", "raytrace.pro", '.pro file in <a href="obj/tools/dir-overview.html">obj/tools/ directory</a>', "raytrace.pro", "", "", "	Traces rays from a camera to a set of objects.        ", "", "          -1", " 	Written by:	Spitale      STATUS: 	Complete ");
