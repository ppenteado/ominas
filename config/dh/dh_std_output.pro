...
;	    dh_put_scalar, dh, 'cam_ny', cam_ny(cds)
	...
	'RNG_DESCRIPTORS'   : $
	   begin
	    ...
	    dh_put_string, dh, 'rng_primary', rng_primary(rds)
	...
	'MAP_DESCRIPTORS'   : $
	   begin
	    ...
	    dh_put_string, dh, 'map_fn_map_to_image', map_fn_map_to_image(mds)
	    dh_put_string, dh, 'map_fn_image_to_map', map_fn_image_to_map(mds)
	    ...
	    dh_put_array, dh, 'map_fn_data', map_fn_data_p(mds)
