...
;-
;===========================================================================
function sedr_vgr_planets, planet, sedr, j2000=j2000, $
 ...
 ;----------------------------
 ; get planet body constants
 ;----------------------------
 case strupcase(planet) of
  'JUPITER' : $
	begin
	 alpha_p = 268.00d
	 delta_p =  64.50d
...
plt_orient = me
 ...
 ; plt_pos
 ;--------------------------
 plt_pos = transpose([0d,0d,0d])

 ;--------------------------
 ; plt_vel
 ;--------------------------
 plt_vel = transpose([0d,0d,0d])
