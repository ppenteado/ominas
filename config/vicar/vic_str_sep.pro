...
;-
function vic_str_sep, str, separator, REMOVE_ALL = remove_all, TRIM = trim, ESC=esc
...
if keyword__set(trim) then arr = strtrim(arr,2) $
else if keyword__set(remove_all) then arr = strcompress(arr, /REMOVE_ALL)
return, arr
end
