...
----------------------------------------------------------
   ...
   the ISS I-kernel might have an entry as follows:
           ...
           TEXT_KERNEL_ID += 'IAU_ISS V0.0.0 29-SEPTEMBER-1999 IK'
                                  |          |         |            |
                                  |          |         |            |
              KERNEL NAME <-------+          |         |            |
                                             |         |            V
   ...
   Cassini Small Satellites Frame Kernel Version:
           ...
           TEXT_KERNEL_ID += 'ROCKS V4.0 30-NOV-2004 FK'
...
Version 4.0 - November 30, 2004 - Diane Conner
            ...
            -- Added new body names S1_2004 & S2_2004.
...
----------------------------------------------------------
     ...
     \begindata
      FRAME_IAU_S1_2004       = 632
      FRAME_632_NAME          ='IAU_S1_2004' 
      FRAME_632_CLASS         =  2
      FRAME_632_CLASS_ID      = 632
      FRAME_632_CENTER        = 0
      OBJECT_632_FRAME        = 'IAU_S1_2004'
     \begintext
...
----------------------------------------------------------
     ...
     \begindata
      FRAME_IAU_S2_2004   = 633
      FRAME_633_NAME      = 'IAU_S2_2004'
      FRAME_633_CLASS     =  2
      FRAME_633_CLASS_ID  = 633
      FRAME_633_CENTER    = 0
      OBJECT_633_FRAME    = 'IAU_S2_2004'
     \begintext
...
----------------------------------------------------------
     ...
     \begindata
      FRAME_IAU_S5_2004   = 635
      FRAME_635_NAME      = 'IAU_S5_2004'
      FRAME_635_CLASS     =  2
      FRAME_635_CLASS_ID  = 633
      FRAME_635_CENTER    = 0
      OBJECT_635_FRAME    = 'IAU_S5_2004'
     \begintext
