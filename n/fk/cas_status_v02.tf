...
----------------------------------------------------------
   ...
   Cassini Frame Kernel Version:
           ...
           TEXT_KERNEL_ID += 'CASSINI_STATUS V2.0 20-JUNE-2005 FK'
...
----------------------------------------------------------
          ...
          2.  Modified Keyword format to agree with approved ECR above.
...
FRAME-82370_BVT_STATUS     = 'ACTIVE'     
FRAME-82371_BVT_STATUS     = 'ELIGIBLE'   
