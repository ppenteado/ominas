...
;		the environment variable OMINAS_UNITS is checked.  If 
;		still no unit system ecists, then it defaults to 'mks'.
;
;  OUTPUT:
;       NONE
;
...
;       OMINAS_UNITS:   Selects the unit system to use if one has not been set 
