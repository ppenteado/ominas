...
function strip_comment, _lines, comment_char=comment_char, $
      only_char=only_char, exclude_char=exclude_char, w=_w, raw=raw
...
new_lines = str_nnsplit(lines, comment_char)
if(NOT keyword_set(raw)) then new_lines = strtrim(new_lines, 2)
