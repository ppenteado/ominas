...
if getenv('IDL_PATH') then begin
  ...
  if getenv('OMINAS_VERBOSITY') then print,'Got path from IDL_PATH'
endif else begin
  path=PREF_GET('IDL_PATH')
  if getenv('OMINAS_VERBOSITY') then print, 'Got path from preferences'
endelse
