...
;; both fail for eclipse example
 ...
 ;-------------------------------------------------------------------------
 od = cor_gd(ptd, /od)
 if(NOT keyword_set(od)) then return, -1
 for i=0, n_elements(w)-1 do $
  begin
   ii = w[i]
   od0 = cor_gd(ptd0[ii], /od)
   if(keyword_set(od0)) then $
...
;
;=============================================================================
function __grim_match_overlays, ptd, ptd0, general=general
...
;**   gd = *plane.gd_p
   ...
   ;- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
   ; replace existing overlay arrays with recomputed ones
   ;- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
